class LandlordsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @landlord.save
         ...
         UserMailer.welcome(@landlord).deliver_now #this will send the email
  ...
  private
    ...
    def landlord_params
      params.require(:landlord).permit(:name, :email, :phone, :reviews, :room_id, :password,:password_confirmation)
    end
end
