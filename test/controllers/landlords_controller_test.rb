...
class LandlordsControllerTest < ActionController::TestCase
  ...
  test "should create landlord" do
    assert_difference('Landlord.count') do
      post :create, landlord: { email: @landlord.email, name: @landlord.name, phone: @landlord.phone, reviews: @landlord.reviews, room_id: @landlord.room_id }
    end
  ...
  test "should update landlord" do
    patch :update, id: @landlord, landlord: { email: @landlord.email, name: @landlord.name, phone: @landlord.phone, reviews: @landlord.reviews, room_id: @landlord.room_id }
    assert_redirected_to landlord_path(assigns(:landlord))
  end
